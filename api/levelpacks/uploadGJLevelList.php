<?php
    ...
    $List->list_name = !empty(ExploitPatch::remove($_POST["listName"])) ? ExploitPatch::remove($_POST["listName"]) : "Unnamed list";
    $List->list_description = ExploitPatch::remove($_POST["listDesc"]);
    $List->levels_list = ExploitPatch::remove($_POST["listLevels"]);
    ...
    $uploadList = $List->upload_list($accountID, $listID);
